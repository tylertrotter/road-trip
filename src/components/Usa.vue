<template>
  ...
  <div class="info">
    <div>Current Location: {{ currentPoint.name }}</div> 
...
export default {
  ...
  methods: {
    ...
    handlePointClick(pointName) {
      ...
      if (this.isPossible())
        this.consideredDistance = this.possibleDrives.find(drive => drive.includes(this.consideredPoint.name))[2];
    },
    ...
    getPossibleDrives() {
      this.possibleDrives = distances.filter(drive => drive.includes(this.currentPoint.name));
    },
    isPossible() {
      return this.consideredPoint && typeof this.possibleDrives.find(drive => drive.includes(this.consideredPoint.name)) !== 'undefined';
    },
    clearRoute() {
      this.legs = [];
      this.init();
