...
export default {
  ...
  methods: {
    ...
    handlePointClick(pointName) {
      ...
      if (this.isPossible())
        this.consideredDistance = this.possibleDrives.find(drive => drive.points.includes(this.consideredPoint.name)).distance;
    },
    ...
    getPossibleDrives() {
      this.possibleDrives = distances.filter(drive => drive.points.includes(this.currentPoint.name));
    },
    isPossible() {
      return this.consideredPoint && typeof this.possibleDrives.find(drive => drive.points.includes(this.consideredPoint.name)) !== 'undefined';
    },
    clearRoute() {
      this.legs = [];
      this.init();
